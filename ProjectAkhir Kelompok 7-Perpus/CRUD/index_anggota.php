...
?>  
  ...
  <h1 class="text-center text-5xl font-medium mb-3" id="katalog">Katalog<span style="color:#ADFF2F;">.</span> </h1> 
  <p class="text-lg mb-6 text-center" >member</p>
  
  <a href="logout.php" class="button ml-20">Logout</a>
